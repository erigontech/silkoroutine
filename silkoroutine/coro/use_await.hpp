...
#ifndef SILKOROUTINE_CORO_USE_AWAIT_HPP_
#define SILKOROUTINE_CORO_USE_AWAIT_HPP_
...
class asio::async_result<silkoroutine::coro::use_await_t, R(Args...)> {
private:
...
public:
    template <typename Initiation, typename... InitArgs>
    static auto initiate(Initiation initiation, silkoroutine::coro::use_await_t, InitArgs... init_args) {
...
#endif // SILKOROUTINE_CORO_USE_AWAIT_HPP_
